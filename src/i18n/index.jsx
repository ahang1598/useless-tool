...
const ZH = {
  ...
  disc: {
    ...
    hintIdle: '选择一个模式开始你的「自律」之旅。建议从学习开始，因为它会以 100 倍速膨胀，让你立刻成就感爆棚。',
    hintStudy: '正在「学习」中……计时以 100 倍速疯涨。你看起来比谁都努力，虽然现实里你只是在盯着屏幕发呆。',
    hintRest: '正在休息，计时按真实速度走。这一栏很诚实，也正因为诚实，所以格外残忍。',
...
const EN = {
  ...
  disc: {
    ...
    hintIdle: 'Pick a mode to start your "discipline" journey. We recommend Study first — it inflates at 100x, so the dopamine hits instantly.',
    hintStudy: 'Studying… the timer is racing at 100x. You look incredibly productive, even though in reality you are just staring at the screen.',
    hintRest: 'Resting. Time flows at honest 1x speed. This column is brutally honest.',
